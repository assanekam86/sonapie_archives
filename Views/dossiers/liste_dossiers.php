...
<!--            <a href="/dossiers/ajouter" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Ajouter Dossier</a>
-->          </div>
...
<table class="table table-bordered table-striped table-hover" id="dataTable" data-order="[[ 8, &quot;desc&quot; ]]" width="100%" cellspacing="0">
<thead>
		<tr>
		<th>Dossier</th>
		<th>Description</th>
	...
	<tbody>
		<?php foreach($dossiers as $dossier):?>
			<tr>
				...
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?=$dossier->desc_dossier;?></td>
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?=strtoupper($dossier->nom." ".$dossier->prenom);?></td>
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?=$dossier->designation;?></td>
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?=$dossier->boite;?></td>
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?=$dossier->etagere;?></td>
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?=$dossier->rayon?></td>
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?=$dossier->salle;?></td>
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?=$dossier->ville;?></td>
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?= $dossier->date_creation_dossier ;?></td>
				<td><a href="/documents/liste_pieces/<?= $dossier->id;?>" style="color: gray;"><?= $dossier->update_at;?></td>
				<td>

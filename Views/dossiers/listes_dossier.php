...
if(isset($_SESSION['user'])){
   ...
   ?>
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="/dossiers/ajouter_dos/<?=$boite->id;?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Ajouter un dossier</a>
          </div>
<div class="card shadow mb-4">
    <div class="card-header py-3">
      <h1 class="m-0 font-weight-bold text-primary"><?=$boite->id!=""? "BOITE : ".$boite->boite." -":"";?> LISTE DES DOSSIERS</h1>

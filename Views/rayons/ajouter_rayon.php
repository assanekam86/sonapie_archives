                                    ...
                                    <label for="etagere" class="control-label mb-1">Salle du rayon</label>
                                        <select name="salle" class="form-control single" id="salle" disabled>
                                          ...
                                          <?php
                                                ...
                                                <option value="<?= $salle->id; ?>"<?=$sal->id==$salle->id?'selected=selected':'';  ?>>
                                        ...
                                        <input type="hidden" name="salle" value="<?=$sal->id;?>"/>                                   
                                      </div>
                            
                                    <div class=" col-md-4 form-group">
                                    <label for="doss" class="control-label mb-1">Ville</label>
                                       <!--<input type="text" name="ville" value="" id="ville" class="form-control" /> -->
                                        <select name="ville" class="form-control single " id="vill" disabled>
                                            
                                         <option value=""><?=$sal->ville;?></option>
                                        </select>                                     
                                    </div>

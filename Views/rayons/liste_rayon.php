   ...
   ?>
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"></h1>
             <?php if($salle != null){ ?>
            <a href="/rayons/ajouter_rayon/<?=$salle->id;?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Ajouter Rayon</a>
          <?php }else{?>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
      <h1 class="m-0 font-weight-bold text-primary"><?=$salle->id!=""? "SALLE : ".$salle->salle." -":"";?> LISTE DES RAYONS</h1>
       </div>
       <div class="card-body">

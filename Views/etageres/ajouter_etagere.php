                      ...
                      <div class="row">
                            <div class="col-md-6 form-group">
                                    <label for="etagere" class="control-label mb-1">Rayon de l'étagère</label>
                                         ...
                                         <input type="text" disabled class="form-control" name="ray" value="<?=$etage->rayon;?>"> 
                                        <input type="hidden" name="rayon" value="<?=$etage->id;?>">                                   
                                      </div>
                           
                                    <div class=" col-md-3 form-group">
                                    <label for="doss" class="control-label mb-1">Ville</label>
                                       <!--<input type="text" name="ville" value="" id="ville" class="form-control" /> -->
                                        <input type="text" name="ville" disabled value="<?=$etage->ville; ?>" class="form-control">                                     
                                    </div>
                                     <div class=" col-md-3 form-group">
                                    <label for="doss" class="control-label mb-1">Salle</label>
                                       <!--<input type="text" name="ville" value="" id="ville" class="form-control" /> -->
                                        <input type="text" name="salle" disabled value="<?=$etage->salle; ?>" class="form-control " >                                     
                                    </div>

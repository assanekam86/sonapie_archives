...
<hr>
                                    ...
                                    <select id="domaine" name="domaines" class="form-control" aria-required="true" aria-invalid="false" disabled>
                                          ...
                                          <?php
                                            if($rows>0){
                                              ...
                                              while($row = $result->fetch(PDO::FETCH_ASSOC)){?>
                                                 <option value="<?=$row['id'];?>" <?= $doss->idcat==$row['id']? 'selected=selected':''; ?>><?=$row['designation'];?></option>
                                                 <?php
                                                    }
                                            }
                                        else{
                                echo '<option value="">Domaine non valable</option>';
                                        ...
                                        <input type="hidden" name="domaine" value="<?=$doss->idcat;?>"> 
                                   </div>
                                ...
                                <div class="row mt-2">
                                   ...
                                   <!-- <select id="type" name="typ" class="form-control types" aria-required="true" aria-invalid="false" disabled>
                                       
                                                <option value="<?=$doss->id ?>" selected="selected"><?= $doss->type;?></option>
                                        
                                   <!-- </select>  -->
                                    <input type="text" disabled value="<?= $doss->type;?>" class="form-control" />
                                                <input type="hidden" name="types" value="<?=$doss->id; ?>">  
                                    </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12 form-group">
                                ...
                                <?php }elseif($doss->id==1 || $doss->id==3){ ?>
                            ...
                            <?php }elseif($doss->id==5 || $doss->id==6){ ?>
                                  <div id="ANL">
                                     <!-- BULLETIN DE SOLDE -->
                                <div class="row"> 
                        ...
                        <?php }elseif($doss->id==14){ ?>
                                ...
                                <?php }elseif($doss->id==10){ ?>
                                  ...
                                  <div class="col-md-4 form-group">
                                    ...
                                    </div><?php }elseif($doss->id==22 || $doss->id==23){ ?>
                                           <div id="COURRI">
                                        <!-- COURRIER -->
...
<div style="color:blue;"><?php if(isset($_SESSION['pieces'])){ echo $_SESSION['pieces'];} ?></div>

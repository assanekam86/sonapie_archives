...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <!--    <?php /*if($affiche != null){ */?>
            <a href="/documents/ajout_pieces/<?php /*=$affiche->id;*/?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Ajouter une pièce</a>
          <?php /*}else{*/?>
<a href="<?php /*= $_SERVER['HTTP_REFERER']; */?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-arrow-left fa-sm text-white-50"></i> Retour</a>

      --><?php /*} */?>
    <a href="/documents/ajout_pieces/<?=$affiche->id;?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
        <i class="fas fa-plus fa-sm text-white-50"></i> Ajouter une pièce
    </a>
...
<div class="card shadow mb-4" id="h1">
    ...
    <!--  <h1 class="m-0 font-weight-bold text-primary"><?=$affiche->id!=""? "DOSSIER : ".$affiche->dossier." -":"";?> LISTE DES PIECES</h1>
 -->
        <h1 class="m-0 font-weight-bold text-primary"><?= ($affiche && is_object($affiche)) ? "DOSSIER : ".$affiche->dossier." -" : ""; ?> LISTE DES PIECES</h1>

                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <label for="doss" class="control-label mb-1">Dossier</label>
                                                ...
                                                <input type="text" disabled value="<?= $doss->dossier;?> (Boite: <?= $doss->boite;?>| Etagère: <?=$doss->dossier;?>| Rayon: <?= $doss->rayon;?>| Salle: <?= $doss->salle;?>| Ville: <?= $doss->ville;?>)" class="form-control" />
                                                <input type="hidden" name="dossier" value="<?=$doss->id; ?>">

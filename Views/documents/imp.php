...
copy("archives/$afficheFile->designation/$afficheFile->typ/$afficheFile->dossier/$afficheFile->fichier","pdf-uploaded/".$afficheFile->fichier);
  ...
  $srcfile ="pdf-uploaded/$afficheFile->fichier";
		if(!is_dir("pdf-compatible")){
  mkdir("pdf-compatible",0777);
 }
 copy("archives/$afficheFile->designation/$afficheFile->typ/$afficheFile->dossier/$afficheFile->fichier","pdf-compatible/".$afficheFile->fichier);
...
require_once('fpdf/vendor/autoload.php');
  ...
  $pdf->useTemplate($pageId, 10, 10, 198);
...
ob_end_clean();
$pdf->Output('F',date("d-m-Y").'-generated.pdf');
//}
...
*/
  ?>
<object data="/<?=date('d-m-Y');?>-generated.pdf" type="application/pdf"
        width="100%" height="705" typemustmatch>
  <p>Vous pouvez télécharger le PDF ici <a  class="btn btn-primary" href="/<?=date('d-m-Y');?>-generated.pdf">télécharger le fichier.</a></p>
</object>

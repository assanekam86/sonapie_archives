...
if(isset($_SESSION['user'])){
 //var_dump($afficheFile->reference); exit;
   ?>
<div class="card shadow mb-4">
    <div class="card-header py-3">
             <h1 class="m-0 font-weight-bold text-primary">DEPOSER UNE PIECE</h1>
    </div>
...
<thead>
        ...
        <?php foreach ($affiche as $files ): ?>
            ...
            <tr>
                ...
                <td width="5%">
                    ...
                    <a class="btn btn-primary" title="Voir le fichier" href="/archives/<?= $files->designation."/".$files->typ."/".$files->dossier."/".$files->fichier;?>">
                <?php
 ...
 ?>
        ...
        <div class="row m-t-30">
            ...
            <div style="color:white;font-size: 16px;text-align: center; background: red; padding: 15px; letter-spacing: 2px; font-weight:bold;" >EMPRUNTEUR : <?= $useremp->matricule." ".$useremp->nom." ".$useremp->prenom;?></div>
                              <div class="row">
                                  
                              <input type="hidden" value="<?= $afficheFile->id;?>" name="entree">

                           <div class="form-group col-md-8">    
                                    <label for="category_id" class="control-label mb-1" style="color:red; font-weight: bolder;">Deposant </label>
                                        ...
                                        <option value="">Choisir utilisateur</option>
                                          ...
                                          <?php
                                                ...
                                                foreach($users as $user){?>
                                                 <option value="<?= $user->matricule." - ".strtoupper($user->nom)." ".strtoupper($user->prenom);?>">
                                                    <?= $user->matricule." - ".strtoupper($user->nom)." ".strtoupper($user->prenom);?>
                             ...
                             <div class="form-group col-md-4">
                                    <label for="slug" class="control-label mb-1"  style="color:red; font-weight: bolder;">Date Depot</label>
                                    
                                    <input id="slug" name="datedepot" type="datetime-local" class="form-control" aria-required="true" aria-invalid="false" required>                        
                                </div>

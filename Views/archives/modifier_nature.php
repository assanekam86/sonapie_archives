                    ...
                    <blockquote class="blockquote mb-0">
                      <form action="" method="post" enctype="multipart/form-data">
                             ...
                             <div class="form-group">
                                    ...
                                    <input id="slug" name="natures" placeholder="Entrer la Nature"  value="<?= $natures->designation; ?>" type="text" class="form-control" aria-required="true" aria-invalid="false" required>            
                            </div>
                            <div class="row mt-2">

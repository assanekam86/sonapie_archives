...
<?php }elseif($files->type == "png" || $files->type == "jpeg" || $files->type == "jpg" || $files->type == "gif") {  //$_SESSION['fichier_id']=$files->id;?>
	<div class="dropdown-item">
		<a href="/documents/imprime/<?=$files->id?>" class="btn btn-info" onclick="javascript:imprime_bloc('titre','imprime_moi');" target="_blank" title="Voir la pièce"  target="_blank">

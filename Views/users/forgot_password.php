          ...
          foreach(Form::getFlash() as $type => $message):  ?>
                ...
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">Entrez simplement votre adresse email ci-dessous et nous vous enverrons un portail pour réinitialiser votre mot de passe!</p>
                  </div>
                  <form class="user" method="post" action="">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" name="email" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Entrer votre adresse Email ..." name="email">
                    </div>

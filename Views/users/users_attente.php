...
if(isset($_SESSION['user'])){
   ...
   ?>
<h1 class="text-center">LISTE DES UTILISATEURS DESACTIV&Eacute;S</h1>
<div class="card-body">
		...
		<?php foreach($users as $user):?>
			<tr>
				...
				<div class="custom-control custom-switch">
 				 <input type="checkbox" class="custom-control-input" id="customSwitch<?=$user->id;?>" <?= $user->actif ? 'checked':''?> data-id="<?=$user->id;?>" <?= $_SESSION['user']['roles'] != 'USER_ADMIN'? 'disabled':''?> title="Cliquer pour activer ou Désactiver">
